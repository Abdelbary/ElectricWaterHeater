this project is implementation of the Swift Act requirement of Electrical Water Heater \href{Kit_info\\Electric Water Heater.pdf}{\texttt{ link}}. \hypertarget{md_documentation_autotoc_md1}{}\doxysection{Demo}\label{md_documentation_autotoc_md1}
